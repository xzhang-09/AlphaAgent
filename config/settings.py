...
from config.env import get_env, get_env_bool, get_env_path, load_dotenv
...
class Settings(BaseModel):
    ...
    fred_api_key: str | None = Field(default_factory=lambda: get_env("FRED_API_KEY"))
    edgar_user_agent: str | None = Field(default_factory=lambda: get_env("EDGAR_USER_AGENT"))
    ...
    enable_response_cache: bool = Field(default_factory=lambda: get_env_bool("ENABLE_RESPONSE_CACHE", False))
